...
Route::get('/auth/line/redirect', [AuthController::class, 'redirectToLine'])->name('auth.line.redirect');
Route::get('/auth/line/callback', [AuthController::class, 'handleLineCallback'])->name('auth.line.callback');
