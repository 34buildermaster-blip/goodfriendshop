        ...
        foreach ($apps as $appData) {
            PremiumApp::updateOrCreate(
                ...
                [
                    ...
                    'customer_required_fields' => ['account_email', 'line_id', 'device'],
                    'warranty_days' => $appData['duration_days'] ?? null,
                    'stock_status' => PremiumApp::STOCK_IN_STOCK,
                    'supplier_name' => null,
                    'supplier_contact' => null,
                    'fulfillment_note' => 'ตรวจสอบยอดชำระ รับข้อมูลบัญชีจากลูกค้า แล้วดำเนินการตาม supplier ที่ร้านเลือก',
                    'terms' => 'รับประกันตามระยะเวลาใช้งาน หากพบปัญหาให้ติดต่อแอดมินพร้อมเลขออเดอร์',
